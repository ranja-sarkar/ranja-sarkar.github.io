...
So we are back to correlation, the measure with which we started the topic here. We shall see how correlation and covariance are different. Well, correlation is not only a measure of how two variables move wrt each other, but also how strongly those two are related. Its value lie between -1 and +1.
