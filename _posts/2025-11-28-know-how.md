...
So we are back to correlation, the measure with which we started the topic here. We shall see how correlation and covariance are different. Well, correlation is not only a <img width="529" height="203" alt="corr" src="https://github.com/user-attachments/assets/40d2a129-19c8-427f-8660-7cf0a805750f" />
measure of how two variables move wrt each other, but also how strongly those two are related. Its value lie between -1 and +1.

<img width="529" height="203" alt="corr" src="https://github.com/user-attachments/assets/8176e107-80c9-4ddc-b5c0-a51a30e2b0b3" />


Covariance provides the direction of relationship and has dimensions (as the variable scale/unit), while correlation provides the direction adn strength of relationship and is dimensionless. 

<img width="443" height="112" alt="co0" src="https://github.com/user-attachments/assets/1d652478-aa2f-46c0-b73e-528173132df4" />

In a [covariance matrix](https://www.theanalysisfactor.com/covariance-matrices/), each diagonal element is the variance of a variable and the off-diagonals are covariances between two variables. In a correlation matrix, the diaginals are unity.
