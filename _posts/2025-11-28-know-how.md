...
<img width="1365" height="430" alt="tt" src="https://github.com/user-attachments/assets/62993d5f-fca4-47ae-a147-54457e5001bd" />
...
<img width="853" height="262" alt="tests" src="https://github.com/user-attachments/assets/33101d1d-c46e-49c4-a3e4-5ef5df2cb4f2" />


Additionally, **data visualization** is essential. For example, a scatter plot helps us understand which measure (correlation coefficient etc.) to use for the data. The plot helps identify linear, nonlinear relationships between variables and spot outliers (if any) which may influence the correlation.
