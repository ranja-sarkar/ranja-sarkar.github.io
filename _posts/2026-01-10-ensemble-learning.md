...
[Light gradient boosting machine](https://github.com/microsoft/LightGBM) by Microsoft is a fast, distributed, high-performance framework. It is memory efficient, its techniques like exclusive feature bundling (EFB) help reduce memory usage during training. Find a [detailed comparison](https://xgboosting.com/xgboost-vs-lightgbm/) of lightGBM and XGBoost.
