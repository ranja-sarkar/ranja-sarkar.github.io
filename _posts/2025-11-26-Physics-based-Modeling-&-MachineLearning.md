...
The [paper by Jared Willard et al (2020)](https://github.com/ranja-sarkar/ranja-sarkar.github.io/blob/bd0e97bb7a75469e16be738cf528f040927ed0d7/_posts/assets/Phys-ml.pdf) about integrating Physics-based modeling with machine learning makes for an insightful read. The paper provides the goals for why Physics-based models must be integrated and machine learning models, a summary of which is as follows.
 
1. Finding representations of more complex physics-based models ✅
...
2. Discovering governing equations ✅
